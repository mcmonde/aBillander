...
<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
      ...
      <div class="row">
         ...
         <div class="col-md-6">
            ...
            <div class="modal-body" id="modal-body_success" style="display:none">
                <div class="alert alert-success">{{ l('Your email has been sent!', [], 'layouts') }}</div>
            </div>
            <div class="modal-footer" id="modal-footer_success" style="display:none">
              ...
              $.post("{{ URL::to('mail') }}", $(this).serialize(), function(data){
                 ...
                 if (data == 0) {
                    ...
                    if (isNaN(data)) {
                       ...
                       $("#modal-footer").hide();
                       alert('AQUI');
                       $("#modal-body_success").show();
                       $("#modal-footer_success").show();
                       alert('AQUI');
                    }
                 }
