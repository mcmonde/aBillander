    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 text-right">
                <a class="footer-logo" href="http://www.abillander.com/" target="new">S.D.G. <i class="fa fa-bolt"></i> <span>aBillander</span></a> &nbsp; {{l('Version', [], 'layouts')}} {{ App\Configuration::get('SW_VERSION') }} 
